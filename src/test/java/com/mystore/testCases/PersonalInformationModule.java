...
public class PersonalInformationModule extends BaseClass {
    ...
    public void updatePersonalInfoUsingValidData() throws InterruptedException, IOException {
        ...
        personalInfoPage.saveUpdatePersonalInfo(InputData.updateTitle, InputData.updateFirstName, InputData.updateLastName, InputData.updateEmail, InputData.updateBirthDay, InputData.updateBirthMonth, InputData.updateBirthYear, loginPassword,InputData.updatePassword,InputData.updatePassword);
        if (driver.getPageSource().contains("Your personal information has been successfully updated.")) {
            logger.info("Test Passed");
            config.setLoginEmailAndPass(InputData.updateEmail, InputData.updatePassword);
